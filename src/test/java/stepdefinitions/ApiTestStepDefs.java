...
public class ApiTestStepDefs {
    ...
    public void user_sends_get_request_to(String endPoint) {
        response = given().when().get(endPoint);  // This is enough for GET request
...
/*
We are using RestAssured Library only in this project coz we are only
testing the basic GET Request.
 */